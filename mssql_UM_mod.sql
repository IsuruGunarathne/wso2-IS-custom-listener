...
CREATE TABLE  UM_USER (
             ...
             PRIMARY KEY (UM_USER_ID, UM_TENANT_ID),
             UNIQUE(UM_USER_ID),
...
CREATE TABLE  UM_USER_ATTRIBUTE (
			...
			UM_USER_ID VARCHAR(255) NOT NULL,
            UM_TENANT_ID INTEGER DEFAULT 0,
			FOREIGN KEY (UM_USER_ID, UM_TENANT_ID) REFERENCES UM_USER(UM_USER_ID, UM_TENANT_ID),
			PRIMARY KEY (UM_ID, UM_TENANT_ID));
...
CREATE TABLE UM_SHARED_USER_ROLE(
    ...
    FOREIGN KEY(UM_USER_ID,UM_USER_TENANT_ID) REFERENCES UM_USER(UM_USER_ID,UM_TENANT_ID) ON DELETE CASCADE,
    PRIMARY KEY (ID)
);
